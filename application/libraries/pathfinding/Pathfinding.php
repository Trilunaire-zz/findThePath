...
public abstract class Pathfinding {
     ...
     * @param came_from la map des prédécesseurs de chaque sommet sur le chemin pour se rendre au point de départ (<strong>contenu précédent perdu</strong>)0
     */
    static function dijkstraAll(g, start, dist, came_from) {
